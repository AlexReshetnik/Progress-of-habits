...
function Item({ dateCopy, isBorder, color, title, isActive }) {
    ...
    function onDoubleClickHandler(e) {
        ...
        if (strictMode === "strictModeTRUE" && day !== new Date(Date.now()).setHours(0, 0, 0, 0)) return
    ...
    return (
        ...
        >
            ...
            <div className="square"
                ...
                day={+dateCopy}
            >
                {isActive ? (<img src="check.png" alt="" width={23} />) : undefined}
            </div>
        </div >
...
export default memo(Item, (prev, next) => {
    return (+prev.dateCopy == +next.dateCopy) &&
