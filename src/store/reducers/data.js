...
let defdata = [
  {
    ...
    title: "Sports",
    progres: [+new Date("2023-02-20").setHours(0, 0, 0, 0), +new Date("2023-02-21").setHours(0, 0, 0, 0), +new Date("2023-02-23").setHours(0, 0, 0, 0), +new Date("2023-02-18").setHours(0, 0, 0, 0), +new Date("2023-01-12").setHours(0, 0, 0, 0)],
    color: "orange",
  },
  {
    id: Date.now(),
    title: "Learn English",
    progres: [+new Date("2022-02-20").setHours(0, 0, 0, 0), +new Date("2023-02-21").setHours(0, 0, 0, 0), +new Date("2023-02-23").setHours(0, 0, 0, 0), +new Date("2023-02-18").setHours(0, 0, 0, 0), +new Date("2023-01-12").setHours(0, 0, 0, 0)],
    color: "red",
  },
  {
...
export const data = (state = defaultState, action) => {
  ...
  switch (action.type) {
    ...
    case CREATEHABIT:
      state.data.push({
        id: new Date(Date.now()).setHours(0, 0, 0, 0),
        title: action.name,
        progres: [],
        color: action.color,
      });
